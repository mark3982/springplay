'''
	Also, copied from:
		http://pywin32.hg.sourceforge.net/hgweb/pywin32/pywin32/file/c5c768dabcbd/win32/Lib/win32con.py

	I copied to reduce dependancy on seperate executable to install the win32 stuff for Python, and I only
	need the constants below. So this was much easier.
'''
